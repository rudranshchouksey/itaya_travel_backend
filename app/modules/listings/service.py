...
class ListingService:
    @staticmethod
    async def create_listing(session: AsyncSession, listing_in: ListingCreate) -> Listing:
    ...
    @staticmethod
    async def get_by_slug(session: AsyncSession, slug: str, public_only: bool = True) -> Listing | None:
    ...
    async def get_availability(
        ...
        stmt = select(ListingAvailability).where(
            and_(
