...
class DeterministicRecommendationService(RecommendationServiceInterface):
    async def get_recommendations(
        ...
        for listing in listings:
            ...
            score = 1.0
            if preferences.destination_id and listing.destination_id == preferences.destination_id:
                score += 2.0
        ...
        if preferences.destination_id:
            exp_stmt = exp_stmt.where(Experience.destination_id == preferences.destination_id)
        ...
        for exp in experiences:
            score = 1.0
            if preferences.destination_id and exp.destination_id == preferences.destination_id:
                score += 2.0
