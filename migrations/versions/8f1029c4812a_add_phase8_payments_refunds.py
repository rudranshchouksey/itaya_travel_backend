...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_refunds_booking_id"), "refunds", ["booking_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_refunds_idempotency_key"), "refunds", ["idempotency_key"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["booking_item_id"], ["booking_items.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["provider_id"], ["users.id"], ondelete="RESTRICT"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_provider_transactions_id"),
        "provider_transactions",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_provider_transactions_provider_id"),
        "provider_transactions",
        ["provider_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_provider_transactions_booking_id"),
        "provider_transactions",
        ["booking_id"],
        unique=False,
    )
