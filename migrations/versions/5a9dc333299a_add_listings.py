...
down_revision: Union[str, Sequence[str], None] = 'a9e969275740'
...
def upgrade() -> None:
    ...
    sa.Column('property_type', sa.Enum('HOTEL', 'HOSTEL', 'HOMESTAY', 'APARTMENT', 'VILLA', 'CAMP', 'MONASTERY', 'ASHRAM', 'RESORT', 'CO_LIVING', 'UNIQUE_STAY', name='property_type_enum'), nullable=False),
    ...
    sa.Column('status', sa.Enum('DRAFT', 'PUBLISHED', 'UNLISTED', name='listing_status_enum'), nullable=False),
    ...
    op.create_table('listing_availabilities',
    sa.Column('listing_id', sa.Uuid(), nullable=False),
    ...
    op.create_index(op.f('ix_listing_availabilities_date'), 'listing_availabilities', ['date'], unique=False)
    op.create_index(op.f('ix_listing_availabilities_id'), 'listing_availabilities', ['id'], unique=False)
    op.create_index(op.f('ix_listing_availabilities_is_available'), 'listing_availabilities', ['is_available'], unique=False)
    op.create_index(op.f('ix_listing_availabilities_listing_id'), 'listing_availabilities', ['listing_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_listing_availabilities_listing_id'), table_name='listing_availabilities')
    op.drop_index(op.f('ix_listing_availabilities_is_available'), table_name='listing_availabilities')
    op.drop_index(op.f('ix_listing_availabilities_id'), table_name='listing_availabilities')
    op.drop_index(op.f('ix_listing_availabilities_date'), table_name='listing_availabilities')
